...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    // Body
    tracep->declBit(c+77,"clk",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBit(c+78,"rst",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBus(c+79,"pc",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBit(c+80,"ram_we",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBus(c+81,"ram_addr",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBus(c+82,"ram_wdata",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    ...
    tracep->declBus(c+83,"snpc",-1, FST_VD_IMPLICIT,FST_VT_VCD_WIRE, false,-1, 31,0);
    ...
    tracep->declBit(c+23,"branch_taken",-1, FST_VD_IMPLICIT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBus(c+24,"branch_target",-1, FST_VD_IMPLICIT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBit(c+25,"ecall_taken",-1, FST_VD_IMPLICIT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBus(c+26,"ecall_target",-1, FST_VD_IMPLICIT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBus(c+27,"load_data",-1, FST_VD_IMPLICIT,FST_VT_VCD_WIRE, false,-1, 31,0);
    ...
    tracep->declBus(c+79,"pc",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    ...
    tracep->declBit(c+25,"ecall_taken",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBus(c+26,"ecall_target",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBit(c+23,"branch_taken",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBus(c+24,"branch_target",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBus(c+29,"operand_a",-1, FST_VD_IMPLICIT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBus(c+30,"operand_b",-1, FST_VD_IMPLICIT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBus(c+31,"csr_read_data",-1, FST_VD_IMPLICIT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBus(c+37,"mstatus",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 31,0);
    tracep->declBus(c+38,"mepc",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 31,0);
    tracep->declBus(c+39,"mcause",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 31,0);
    tracep->declBus(c+40,"mtvec",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 31,0);
    tracep->declBit(c+32,"branch_cond",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    ...
    tracep->declBit(c+77,"clk",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBit(c+78,"rst",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBit(c+25,"ecall_taken",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBus(c+26,"ecall_target",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBit(c+23,"branch_taken",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBus(c+24,"branch_target",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBus(c+79,"pc",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBus(c+83,"snpc",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBus(c+1,"inst",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBus(c+41,"pc_ff",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 31,0);
    tracep->declBus(c+35,"dnpc",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 31,0);
    tracep->declBus(c+42,"msnpc",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 31,0);
    tracep->declBus(c+43,"mdnpc",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+27,"load_data",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBit(c+80,"ram_we",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBus(c+81,"ram_addr",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBus(c+82,"ram_wdata",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    ...
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+44+i*1,"registers",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, true,(i+0), 31,0);
    }
    tracep->declBus(c+76,"i",-1, FST_VD_IMPLICIT,FST_VT_VCD_INTEGER, false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("wbu ");
    tracep->declBus(c+22,"alu_result",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBus(c+27,"load_data",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
    tracep->declBus(c+83,"snpc",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1, 31,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+22,(vlSelf->top__DOT__alu_result),32);
    bufp->fullBit(oldp+23,((((IData)(vlSelf->top__DOT__branch) 
    ...
    bufp->fullIData(oldp+24,(((IData)(vlSelf->top__DOT__exu__DOT____VdfgTmp_h826bb330__0)
    ...
    bufp->fullBit(oldp+25,(vlSelf->top__DOT__ecall_taken));
    bufp->fullIData(oldp+26,(vlSelf->top__DOT__ecall_target),32);
    bufp->fullIData(oldp+27,(vlSelf->top__DOT__load_data),32);
    bufp->fullCData(oldp+28,((7U & (vlSelf->top__DOT__inst_out 
                                    >> 0xcU))),3);
    bufp->fullIData(oldp+29,(vlSelf->top__DOT__exu__DOT__operand_a),32);
    bufp->fullIData(oldp+30,(vlSelf->top__DOT__exu__DOT__operand_b),32);
    bufp->fullIData(oldp+31,(((0x300U == vlSelf->top__DOT__imm)
                               ...
                               : ((0x341U == vlSelf->top__DOT__imm)
                                   ...
                                   : ((0x342U == vlSelf->top__DOT__imm)
                                       ...
                                       : ((0x305U == vlSelf->top__DOT__imm)
                                           ...
                                           : 0U))))),32);
    bufp->fullBit(oldp+32,((((IData)(vlSelf->top__DOT__alu_op) 
                             >> 3U) & ((4U & (IData)(vlSelf->top__DOT__alu_op))
                                        ...
                                        : (((IData)(vlSelf->top__DOT__alu_op) 
                                           ...
                                           & ((1U & (IData)(vlSelf->top__DOT__alu_op))
                                               ...
                                               : (vlSelf->top__DOT__rs1_data 
                                                  == vlSelf->top__DOT__rs2_data)))))));
    bufp->fullCData(oldp+33,((0x7fU & vlSelf->top__DOT__inst_out)),7);
    bufp->fullCData(oldp+34,((vlSelf->top__DOT__inst_out 
                              >> 0x19U)),7);
    bufp->fullIData(oldp+35,(vlSelf->top__DOT__ifu__DOT__dnpc),32);
    bufp->fullIData(oldp+36,(vlSelf->top__DOT__lsu__DOT__temp_data),32);
    bufp->fullIData(oldp+37,(vlSelf->top__DOT__exu__DOT__mstatus),32);
    bufp->fullIData(oldp+38,(vlSelf->top__DOT__exu__DOT__mepc),32);
    bufp->fullIData(oldp+39,(vlSelf->top__DOT__exu__DOT__mcause),32);
    bufp->fullIData(oldp+40,(vlSelf->top__DOT__exu__DOT__mtvec),32);
    bufp->fullIData(oldp+41,(vlSelf->top__DOT__ifu__DOT__pc_ff),32);
    bufp->fullIData(oldp+42,(vlSelf->top__DOT__ifu__DOT__msnpc),32);
    bufp->fullIData(oldp+43,(vlSelf->top__DOT__ifu__DOT__mdnpc),32);
    bufp->fullIData(oldp+44,(vlSelf->top__DOT__reg_file__DOT__registers[0]),32);
    bufp->fullIData(oldp+45,(vlSelf->top__DOT__reg_file__DOT__registers[1]),32);
    bufp->fullIData(oldp+46,(vlSelf->top__DOT__reg_file__DOT__registers[2]),32);
    bufp->fullIData(oldp+47,(vlSelf->top__DOT__reg_file__DOT__registers[3]),32);
    bufp->fullIData(oldp+48,(vlSelf->top__DOT__reg_file__DOT__registers[4]),32);
    bufp->fullIData(oldp+49,(vlSelf->top__DOT__reg_file__DOT__registers[5]),32);
    bufp->fullIData(oldp+50,(vlSelf->top__DOT__reg_file__DOT__registers[6]),32);
    bufp->fullIData(oldp+51,(vlSelf->top__DOT__reg_file__DOT__registers[7]),32);
    bufp->fullIData(oldp+52,(vlSelf->top__DOT__reg_file__DOT__registers[8]),32);
    bufp->fullIData(oldp+53,(vlSelf->top__DOT__reg_file__DOT__registers[9]),32);
    bufp->fullIData(oldp+54,(vlSelf->top__DOT__reg_file__DOT__registers[10]),32);
    bufp->fullIData(oldp+55,(vlSelf->top__DOT__reg_file__DOT__registers[11]),32);
    bufp->fullIData(oldp+56,(vlSelf->top__DOT__reg_file__DOT__registers[12]),32);
    bufp->fullIData(oldp+57,(vlSelf->top__DOT__reg_file__DOT__registers[13]),32);
    bufp->fullIData(oldp+58,(vlSelf->top__DOT__reg_file__DOT__registers[14]),32);
    bufp->fullIData(oldp+59,(vlSelf->top__DOT__reg_file__DOT__registers[15]),32);
    bufp->fullIData(oldp+60,(vlSelf->top__DOT__reg_file__DOT__registers[16]),32);
    bufp->fullIData(oldp+61,(vlSelf->top__DOT__reg_file__DOT__registers[17]),32);
    bufp->fullIData(oldp+62,(vlSelf->top__DOT__reg_file__DOT__registers[18]),32);
    bufp->fullIData(oldp+63,(vlSelf->top__DOT__reg_file__DOT__registers[19]),32);
    bufp->fullIData(oldp+64,(vlSelf->top__DOT__reg_file__DOT__registers[20]),32);
    bufp->fullIData(oldp+65,(vlSelf->top__DOT__reg_file__DOT__registers[21]),32);
    bufp->fullIData(oldp+66,(vlSelf->top__DOT__reg_file__DOT__registers[22]),32);
    bufp->fullIData(oldp+67,(vlSelf->top__DOT__reg_file__DOT__registers[23]),32);
    bufp->fullIData(oldp+68,(vlSelf->top__DOT__reg_file__DOT__registers[24]),32);
    bufp->fullIData(oldp+69,(vlSelf->top__DOT__reg_file__DOT__registers[25]),32);
    bufp->fullIData(oldp+70,(vlSelf->top__DOT__reg_file__DOT__registers[26]),32);
    bufp->fullIData(oldp+71,(vlSelf->top__DOT__reg_file__DOT__registers[27]),32);
    bufp->fullIData(oldp+72,(vlSelf->top__DOT__reg_file__DOT__registers[28]),32);
    bufp->fullIData(oldp+73,(vlSelf->top__DOT__reg_file__DOT__registers[29]),32);
    bufp->fullIData(oldp+74,(vlSelf->top__DOT__reg_file__DOT__registers[30]),32);
    bufp->fullIData(oldp+75,(vlSelf->top__DOT__reg_file__DOT__registers[31]),32);
    bufp->fullIData(oldp+76,(vlSelf->top__DOT__reg_file__DOT__i),32);
    bufp->fullBit(oldp+77,(vlSelf->clk));
    bufp->fullBit(oldp+78,(vlSelf->rst));
    bufp->fullIData(oldp+79,(vlSelf->pc),32);
    bufp->fullBit(oldp+80,(vlSelf->ram_we));
    bufp->fullIData(oldp+81,(vlSelf->ram_addr),32);
    bufp->fullIData(oldp+82,(vlSelf->ram_wdata),32);
    bufp->fullIData(oldp+83,(((IData)(4U) + vlSelf->pc)),32);
}
